...
group_by_dic = {"stateclass": [("IDScenario", "Timestep","Iteration", "StateLabelX","StateLabelY", "Stratum", "AgeMin", "AgeMax"), ("IDScenario", "Timestep","Iteration", "StateLabelX","StateLabelY", "SecondaryStratum", "AgeMin", "AgeMax"), ("IDScenario", "Timestep","Iteration", "StateLabelX","StateLabelY", "AgeMin", "AgeMax")],
...
def add_strata_all_stateclass(table_type, table_name_dic, group_by_dic, scenarioVals, iterationVals):
    for x in scenarioVals:
        for y in iterationVals:

            iterlist = [y]
            scenlist = [x]

            iterations = tuple(iterlist)
            scenarios = tuple(scenlist)
            group_by = group_by_dic[table_type][0]

            df = db_query_stateclass(sqlite_file, project_id=project_id, scenario_id = scenarios, state_label_x=None, iteration=iterations, stratum=None, secondary_stratum=None, group_by=group_by, percentile = None)
            print('query_done')
...
'''def add_strata_all_stock(table_type, table_name_dic, group_by_dic, scenarios, iterations):
    ...
    print(iterations)
    print(project_id)
    df = db_query_stock(sqlite_file, project_id=project_id, scenario_id = scenarios, iteration=iterations, stratum=None, secondary_stratum=None, group_by=group_by, percentile = None)
    print('query_done')
...
def add_strata_all_transition(table_type, table_name_dic, group_by_dic, scenarioVals, iterationVals):
    ...
    for x in scenarioVals:
        for y in iterationVals:
            ...
            print(iterations)
            print(scenarios)
            df = db_query_transitiongroup(sqlite_file, project_id=project_id, scenario_id = scenarios, iteration=iterations, stratum=None, secondary_stratum=None, group_by= group_by, percentile = None)
            print('query_done')
...
#scenarioVals = [1201, 1202, 1203]#,1201, 1202, 1203
#iterationVals = range(1, 11)
#table_type = "stateclass" #stock transition
#add_strata_all_stateclass(table_type, table_name_dic, group_by_dic, scenarioVals, iterationVals)



#add_strata_all_stock(table_type, table_name_dic, group_by_dic, scenarios, iterations)


scenarioVals = [1120,1201, 1202, 1203]
iterationVals = range(1, 11)
table_type = "transition"
add_strata_all_transition(table_type, table_name_dic, group_by_dic, scenarioVals, iterationVals)